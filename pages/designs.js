...
const designs = () => {
  return (
    <div>
      <DesignsHeader />
      <section
        className='mt-2 pt-2 me-md-5 pb-3 ms-md-5'
        id='designs'
        alt='designs page'
      >
        <Blobs />
        <div className='row border-bottom text-end' id='EcoOceansRow'>
          <div className='col-sm-6 border-end' id='EcoOceansCel'>
            <div className='container mt-5'>
              ...
              <Nav.Link href='/ecooceanshub'>
                <h4>
                  An immersive digital ecosystem uniting marine enthusiasts,
                  scientists, and conservationists through curated resources,
                  collaborative events, and a thriving community dedicated to
                  the cause of ocean preservation.
                </h4>
              </Nav.Link>
            </div>
          </div>
            ...
            <div className='container mt-5'>
              ...
              <Nav.Link href='/greenup'>
                <h4>
                  ...
                  resources, events, and a community of like-minded individuals
                  to support everyone’s sustainability efforts
                </h4>
              </Nav.Link>
            </div>
          </div>
        ...
        <div className='row border-bottom text-end' id='ArtketRow'>
          <div className='col-sm-6 border-end' id='ArtketTitlesCel'>
            <div className='container mt-5 '>
              ...
              <Nav.Link href='/artket'>
                <h4>
                  An art community app to connect artists, collectors, galleries
                  and anyone curious about art
                </h4>
              </Nav.Link>
            </div>
          </div>
          <div className='col-sm-6 d-flex justify-center' id='ArtketLinkText'>
            <div className={` ${utilStyles.designsPicBox} py-4 pe-3 float-end`}>
              <Nav.Link
                href='/artket'
                className=''
        ...
        <div className='row border-bottom' id='RandomRow'>
          <div className='col-sm-6 border-end text-end' id='RandomizeText'>
            <div className='container mt-5'>
              ...
              <p className='pt-4'>
                * This was a fun project, it is unfinished, hence ready to keep
                improving when I feel ready. Stay tuned :){' '}
              </p>
            </div>
          </div>
          <div className='col-sm-6 border-end' id='FigmaSS'>
